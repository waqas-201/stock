...
export const AddItemModal: React.FC<AddItemModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isNaN(parsedThreshold) || parsedThreshold < 0) {
      setError('Please enter a valid low stock alert number (0 or higher)');
      return;
    }
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-slate-500 truncate">
                Configure inventory, unit & alert limits
              </p>
            </div>
          </div>
          <button
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 min-h-[44px] text-sm sm:text-base bg-white border border-slate-300 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-emerald-600 focus:border-transparent text-slate-900 placeholder:text-slate-400"
            />
          </div>
          ...
          {/* 3. Quantity and 4. Low Stock Alert Limit (Clean responsive grid with min-w-0) */}
          ...
          <div className="p-3.5 bg-slate-50/80 border border-slate-200 rounded-2xl space-y-1.5">
            ...
            <p className="text-[11px] text-slate-500">
              Helps track manufacturing batches, expiry limits, and harvest/production cycles.
            </p>
          </div>
          ...
          {/* 7. Notes / Remarks (New requested field) */}
          <div className="p-3.5 bg-slate-50/80 border border-slate-200 rounded-2xl space-y-1.5">
            <label
            ...
            <textarea
              id="add-item-notes"
              rows={2}
              placeholder="e.g., Supplier: Acme Corp, Rack B-3, Batch #109, handle with care..."
              value={notes}
